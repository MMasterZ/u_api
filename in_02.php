            ...
            foreach($sector as $sectorData){
                $tableName =  $expData . "_" . $yearData;
                        ...
                        if($sectorData != '0'){
                            ...
                            $sql2  = "select sum(value) as sum,exp_country, imp_country, year  from " . $tableName . " where (variable = 'DVA_FIN' or variable='DVA_INT' )  and imp_country = '". $impData  ."'";
                        }
                ...
                $tableName =  $expData . "_" . $yearData;
                  ...
                  $tableName2 =  $impData . "_" . $yearData;       
                    if($sectorData != '0'){
                            ...
                            $sql2  = "select sum(value) as sum,exp_country, imp_country, year  from " . $tableName2 . " where (variable = 'DVA_FIN' or variable='DVA_INT' )  and imp_country = '". $expData  ."'";
                        }
                        ...
                        $value1 = $value3[0][0];
                            ...
                            $temp['year'] = $yearData;
                            $temp['indicator_name'] = 'Value-added trade balance as % of gross exports';
                            $temp['unit'] = '% of gross exports to partner';
                        array_push($result,$temp);
                            $temp['value'] = round(($value - $value1),2);
                            $temp['indicator_name'] = 'Value-added trade balance in $US';
